 ...
 */
const computeSummaryValueForColumn = (col: CanvasTable.ColumnOption, rule: string) => {
 ...
 * @param {CanvasTable.ColumnOption[]} summaryCols - 列
 */
export const drawSummaryPart = (summaryGroup: Konva.Group | null, summaryCols: CanvasTable.ColumnOption[]) => {
