...
-- ----------------------------
BEGIN;
INSERT INTO `analyze` (`id`, `analyze_name`, `view_count`, `create_time`, `created_by`, `update_time`, `updated_by`, `current_config_id`, `analyze_desc`, `is_deleted`) VALUES (1, '运营平台活跃用户与收入分析', 120, '2026-06-10 10:00:00', 'admin', '2026-06-11 10:00:00', 'admin', 201, '按平台维度查看活跃用户数和收入柱状图', 0);
INSERT INTO `analyze` (`id`, `analyze_name`, `view_count`, `create_time`, `created_by`, `update_time`, `updated_by`, `current_config_id`, `analyze_desc`, `is_deleted`) VALUES (3, '城市月度气温趋势（折线图）', 85, '2026-06-10 10:00:00', 'admin', '2026-06-11 10:00:00', 'admin', 202, '按月份查看各城市月均气温折线', 0);
...
INSERT INTO `analyze` (`id`, `analyze_name`, `view_count`, `create_time`, `created_by`, `update_time`, `updated_by`, `current_config_id`, `analyze_desc`, `is_deleted`) VALUES (107, '电商品类销售与毛利分析（JOIN）', 88, '2026-06-10 10:00:00', 'admin', '2026-06-11 10:00:00', 'admin', 207, '订单关联商品目录，按品类分析销售额与毛利', 0);
INSERT INTO `analyze` (`id`, `analyze_name`, `view_count`, `create_time`, `created_by`, `update_time`, `updated_by`, `current_config_id`, `analyze_desc`, `is_deleted`) VALUES (108, 'HR部门薪资绩效分析（JOIN）', 72, '2026-06-10 10:00:00', 'admin', '2026-06-11 10:00:00', 'admin', 208, '员工关联部门，按部门分析薪资分布与绩效评分', 0);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1508 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='定时邮件任务执行日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户登录日志表';
