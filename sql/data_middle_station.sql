...
-- ----------------------------
BEGIN;
INSERT INTO `analyse` (`id`, `analyse_name`, `view_count`, `create_time`, `created_by`, `update_time`, `updated_by`, `chart_config_id`, `analyse_desc`, `is_deleted`) VALUES (1, '销售数据看板', 569, '2025-05-30 02:19:10', 'Alice', '2025-07-17 13:38:05', 'system', 5, '销售数据看板的描述', 0);
INSERT INTO `analyse` (`id`, `analyse_name`, `view_count`, `create_time`, `created_by`, `update_time`, `updated_by`, `chart_config_id`, `analyse_desc`, `is_deleted`) VALUES (2, '运营分析图表', 230, '2025-05-30 02:19:10', 'Bob', '2025-05-30 02:19:37', 'Bob', NULL, NULL, 0);
...
INSERT INTO `analyse` (`id`, `analyse_name`, `view_count`, `create_time`, `created_by`, `update_time`, `updated_by`, `chart_config_id`, `analyse_desc`, `is_deleted`) VALUES (5, '收入趋势图表', 320, '2025-05-30 02:19:10', 'Eve', '2025-05-30 02:19:46', 'Eve', NULL, NULL, 0);
COMMIT;
