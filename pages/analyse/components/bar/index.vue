<template>
  <div class="bar relative flex pr-[10px]">
    <el-button link @click="handleClickRefresh">
      刷新
    </el-button>
    <el-checkbox label="查询条件变化时自动刷新" />
    <el-button class="ml-auto" link>分析</el-button>
    ...
    <el-button link @click="handleClickDownload"
      >下载</el-button
    >
    <el-button link @click="handleClickSave"
      >保存</el-button
    >
    <el-tag
...
const { chartUpdateTakesTime, chartUpdateTime } = initData()
const {
  handleClickRefresh,
  handleClickAlarm,
  handleClickSetting,
